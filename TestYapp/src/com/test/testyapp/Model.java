...
public class Model {
    ...
    public static void LoadModel() {
        ...
        Items.add(new Item(1, "foto_espectaculos.png", "Espectaculos","Shakira muestra la primera foto de Milan"));
        Items.add(new Item(2, "foto_hoy.png", "Lo de Hoy","Secuestra a 3 personas en la comunidad"));
        Items.add(new Item(3, "foto_horoscopos.png", "Horoscopos","Aries 5 Febrero..."));
        ...
        Items.add(new Item(6, "foto_deportes.png", "Deportes","Prepara Messi su renovacion con el barca"));
